...
with gcs_bucket.blob(f'stats/diffs_stddev_by_level.nc').open('rb') as f:
    diffs_stddev_by_level = xarray.load_dataset(f).compute()

with gcs_bucket.blob(f'stats/mean_by_level.nc').open('rb') as f:
     mean_by_level= xarray.load_dataset(f,engine='scipy').compute()

with gcs_bucket.blob(f'stats/stddev_by_level.nc').open('rb') as f:
